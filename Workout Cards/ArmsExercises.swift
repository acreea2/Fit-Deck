...
//import UIKit
//
//class ArmsExercises: UIViewController {
//    
...
//        UIView.animate(withDuration: 1.5, delay: 1.1, usingSpringWithDamping: 0.45, initialSpringVelocity: 0, options: UIViewAnimationOptions.curveEaseOut, animations: {
