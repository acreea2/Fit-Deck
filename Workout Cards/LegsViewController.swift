...
class LegsViewController: UIViewController {
    ...
    func CardUpdateAll(){
        self.WorkoutWelcome.text = library.WelcomeArray1.randomItem2()
        self.ExerciseName.text = library.ExerciseNameArray1.randomItem2()
        self.BothNumbers = library.ExerciseNumberArray1.randomItem2()
    ...
    func LastCard() {
        ...
        self.WorkoutWelcome.text = library.ExerciseExitArray1.randomItem2()
